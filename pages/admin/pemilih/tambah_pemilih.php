...
<main class="flex-1 p-6 mt-16 md:ml-64 bg-gray-50 min-h-screen">
    ...
    <h1 class="text-2xl font-bold mb-4">Tambah Pemilih</h1>
    ...
    <form method="POST" class="bg-white shadow rounded-2xl p-6 max-w-xl">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_lengkap" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-500">
        </div>

        <div class="mb-4">
            <label class="block text-gray-700 font-medium mb-1">Kelas</label>
            <input type="text" name="kelas" class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-500">
        </div>
